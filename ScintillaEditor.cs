...
namespace Efficiency.DevTools.CodeAnalysis
{
    public class ScintillaEditor
    {
        public static Scintilla Create()
        {
            Scintilla scintilla = new Scintilla();
            scintilla.Lexer = Lexer.Xml;  
            scintilla.Margins[0].Width = 40; // Show line numbers
            ...
            scintilla.Styles[Style.Xml.DoubleString].ForeColor = Color.DarkMagenta;
            scintilla.Styles[Style.Xml.DoubleString].Bold = true;
            scintilla.Styles[Style.Xml.SingleString].ForeColor = Color.DarkMagenta;
